...
namespace Blish_HUD
{
    public class SpriteBatchParameters
    {
        ...
        public static bool ParamsEqual(SpriteBatchParameters leftSpriteBatchParams,
            SpriteBatchParameters rightSpriteBatchParams)
        {
    ...
    public static class SpriteBatchExtensions
    {
        ...
        public static void DrawOnCtrl(this SpriteBatch spriteBatch, Control ctrl, Texture2D texture,
        ...
        public static void DrawOnCtrl(this SpriteBatch spriteBatch, Control ctrl, TextureRegion2D texture,
            Rectangle destinationRectangle)
        {
            spriteBatch.Draw(texture,
                destinationRectangle.ToBounds(ctrl.AbsoluteBounds),
        ...
        public static void DrawOnCtrl(this SpriteBatch spriteBatch, Control ctrl, Texture2D texture,
            Rectangle destinationRectangle, Rectangle? sourceRectangle, Color color, float rotation, Vector2 origin,
            ...
            VerticalAlignment verticalAlignment = VerticalAlignment.Middle)
        {
            ...
            if ((horizontalAlignment != HorizontalAlignment.Left) && (wrap || text.Contains("\n")))
            {
                using (var reader = new StringReader(text))
                {
                    ...
                    var lineHeightDiff = 0;

                    while ((destinationRectangle.Height - lineHeightDiff > 0) && ((line = reader.ReadLine()) != null))
                    {
                        DrawStringOnCtrl(spriteBatch, ctrl, line, font,
                            destinationRectangle.Add(0, lineHeightDiff, 0, -0), color, wrap, stroke, strokeDistance,
            ...
            var xPos = destinationRectangle.X;
            var yPos = destinationRectangle.Y;
            ...
            if (stroke)
            {
                spriteBatch.DrawString(font, text, textPos.OffsetBy(0, -strokeDistance),
                    Color.Black * ctrl.AbsoluteOpacity());
                spriteBatch.DrawString(font, text, textPos.OffsetBy(strokeDistance, -strokeDistance),
                    Color.Black * ctrl.AbsoluteOpacity());
                spriteBatch.DrawString(font, text, textPos.OffsetBy(strokeDistance, 0),
                    Color.Black * ctrl.AbsoluteOpacity());
                spriteBatch.DrawString(font, text, textPos.OffsetBy(strokeDistance, strokeDistance),
                    Color.Black * ctrl.AbsoluteOpacity());
                spriteBatch.DrawString(font, text, textPos.OffsetBy(0, strokeDistance),
