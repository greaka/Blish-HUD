...
namespace Blish_HUD
{
    public static class RectangleExtension
    {
        ...
        {
            return new Rectangle(rect.X - (int) thickness.Left, rect.Y - (int) thickness.Top,
                rect.Width + (int) thickness.Left + (int) thickness.Right,
                rect.Height + (int) thickness.Top + (int) thickness.Bottom);
        }
        ...
        {
            return new Rectangle((int) Math.Floor(rectangle.X * scale), (int) Math.Floor(rectangle.Y * scale),
                (int) Math.Ceiling(rectangle.Width * scale), (int) Math.Ceiling(rectangle.Height * scale));
        }
    }
}