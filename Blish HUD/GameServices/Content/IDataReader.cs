...
namespace Blish_HUD.Content
{
    ...
    public interface IDataReader : IDisposable
    {
        ...
        /// <summary>
        ///     Returns a string representation of the current path the DataReader is reading from. This won't necessarily be a
        ///     valid file path.
        /// </summary>
        ...
        /// </summary>
        /// <param name="loadFileFunc">
        ///     The method to call on all files within the context of the <see cref="IDataReader" /> that
        ///     have the required file extension.
        /// </param>
        /// <param name="fileExtension">
        ///     The file extension criteria. Should contain the '.' before the extension. If no
        ///     fileExtension is provided, all files will meet the criteria.
        /// </param>
        ...
        ///     If the file does not exist or cannot be read, <see cref="T:null" /> will be returned instead of a
        ///     <see cref="Stream" />.
        /// </returns>
        ...
        ///     If the file does not exist or cannot be read, <see cref="T:null" /> will be returned instead of
        ///     <see cref="T:byte[]" />.
        /// </returns>
        byte[] GetFileBytes(string filePath);

        /// <summary>
        ///     Opens a file, writes the raw data to the provided <see cref="fileBuffer" /> and returns the length of the data
        ///     read.
        /// </summary>
        /// <param name="filePath">A path to a file within the context of the <see cref="IDataReader" />.</param>
        ...
        /// <returns>
        ///     A task that represents the file's opened stream.
        ///     If the file does not exist or cannot be read, the <see cref="Task" /> will result in <see cref="T:null" /> instead
        ///     of a <see cref="Stream" />.
        /// </returns>
