...
namespace Blish_HUD.Settings.UI.Views
{
    public class SettingsView : View<SettingsPresenter>
    {
        ...
        private readonly Dictionary<SettingEntry, ViewContainer> _settingViews =
            new Dictionary<SettingEntry, ViewContainer>();
        ...
        {
            var lastBottom = SETTING_PADDING;

            foreach (var viewSet in this._settingViews)
            {
        ...
        public ViewContainer AddSettingView(SettingEntry setting)
        {
            ...
            this._settingViews.Add(setting, settingContainer);
        ...
        {
            if (this._settingViews.TryGetValue(setting, out var display))
            {
                display.Dispose();
