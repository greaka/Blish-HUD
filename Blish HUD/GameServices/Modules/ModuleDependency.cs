...
namespace Blish_HUD.Modules
{
    public class ModuleDependency
    {
        ...
        public ModuleDependencyCheckDetails GetDependencyDetails()
        {
            ...
            {
                if (this.VersionRange.IsSatisfied(Program.OverlayVersion.BaseVersion()))
                {
            ...
            foreach (var module in GameService.Module.Modules)
            {
                if (string.Equals(this.Namespace, module.Manifest.Namespace, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    return new ModuleDependencyCheckDetails(module.Manifest.Name,
                        ModuleDependencyCheckResult.AvailableWrongVersion, module);
                }
            }
        ...
        internal class VersionDependenciesConverter : JsonConverter<List<ModuleDependency>>
        {
            ...
            public override List<ModuleDependency> ReadJson(JsonReader reader, Type objectType,
                List<ModuleDependency> existingValue, bool hasExistingValue, JsonSerializer serializer)
            {
                ...
                {
                    var dependencyNamespace = prop.Key;
                    var dependencyVersionRange = prop.Value.ToString();
