...
namespace Blish_HUD.Modules
{
    ...
    [JsonSubtypes.KnownSubTypeAttribute(typeof(ManifestV1), SupportedModuleManifestVersion.V1)]
    public abstract class Manifest
    {
        ...
        public Dictionary<TokenPermission, ModuleApiPermissions> ApiPermissions { get; private set; } =
            new Dictionary<TokenPermission, ModuleApiPermissions>();
    }
}