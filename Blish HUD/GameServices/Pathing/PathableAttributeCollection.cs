...
namespace Blish_HUD.Pathing
{
    ...
    {
        public PathableAttributeCollection() : base(StringComparer.OrdinalIgnoreCase)
        {
            /* NOOP */
        }

        /// <summary>
        ///     Create a <see cref="PathableAttributeCollection" /> from an existing <see cref="IEnumerable{T}" />.
        /// </summary>
        /// <param name="attributeCollection"></param>
        public PathableAttributeCollection(IEnumerable<PathableAttribute> attributeCollection) : base(StringComparer
            .OrdinalIgnoreCase)
        {
        ...
        /// <summary>
        ///     If an attribute with the provided
        ...
        /// <inheritdoc />
        protected override string GetKeyForItem(PathableAttribute item)
        {
            return item.Name;
        }
