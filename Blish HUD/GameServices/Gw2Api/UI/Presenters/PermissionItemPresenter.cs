...
namespace Blish_HUD.Gw2Api.UI.Presenters
{
    public class PermissionItemPresenter : Presenter<PermissionItemView, PermissionItemPresenter.PermissionConsent>
    {
        ...
        static PermissionItemPresenter()
        {
            ...
            _descriptionLookup = new Dictionary<TokenPermission, string>
            {
                ...
                [TokenPermission.Inventories] =
                    Strings.GameServices.Gw2ApiService.TokenPermissionDescription_Inventories,
                ...
                [TokenPermission.Tradingpost] =
                    Strings.GameServices.Gw2ApiService.TokenPermissionDescription_Tradingpost,
                ...
                [TokenPermission.Progression] =
                    Strings.GameServices.Gw2ApiService.TokenPermissionDescription_Progression,
                [TokenPermission.Guilds] = Strings.GameServices.Gw2ApiService.TokenPermissionDescription_Guilds
            };
        }

        /// <inheritdoc />
        public PermissionItemPresenter(PermissionItemView view, PermissionConsent model) : base(view, model)
        {
            /* NOOP */
        }
        ...
        protected override void UpdateView()
        {
            ...
            if (_iconLookup.TryGetValue(this.Model.Permission, out var permissionIcon))
            {
            ...
            if (_descriptionLookup.TryGetValue(this.Model.Permission, out var permissionDescription))
            {
        ...
        public class PermissionConsent
        {
            public PermissionConsent(TokenPermission permission, bool required, bool consented = true)
            {
                ...
                this.Consented = required || consented;
            }

            public TokenPermission Permission { get; }
