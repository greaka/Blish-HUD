...
namespace Blish_HUD.Common.UI.Views
{
    public class CenteredView : View<CenterPresenter>
    {
        ...
        {
            this._centeredPanel = new Panel();
            this._centeredPanel.Resized += CenteredPanelOnResized;
            this._centeredPanel.Moved += CenteredPanelOnMoved;
        ...
        protected override void Build(Panel buildPanel)
        {
            ...
            this.Presenter.Model.DoBuild(this._centeredPanel);

            this._centeredPanel.Parent = buildPanel;
        ...
        {
            this._centeredPanel.Location = new Point(this.ViewTarget.Width / 2 - this._centeredPanel.Width / 2,
                this.ViewTarget.Height / 2 - this._centeredPanel.Height / 2);
        }
